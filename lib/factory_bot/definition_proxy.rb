module FactoryBot
  class DefinitionProxy
    ...
    # Adds an attribute that will have unique values generated by a scoped sequence with
    # a specified format.
    #
    # Example:
    #   factory :user do
    #     scoped_sequence(:email, :organization) { |n| "person#{n}@example.com" }
    #   end
    #
    # Arguments:
    # * name: +Symbol+
    ...
    # * scope_name: +Symbol+
    #   The name of the scope for sequential number.
    #   This name must be an attribute accessor for instance.
    #
    def scoped_sequence(name, scope_name, ...)
      sequence = ScopedSequence.new(name, scope_name, ...)
