    ...
    module Vintage
      module Factory
        ...
        def self.define(name, options = {})
          factory = FactoryWoman::Factory.new(name, options)
          proxy = FactoryWoman::DefinitionProxy.new(factory)
          yield(proxy)
        ...
        def self.default_strategy(name, overrides = {})
          FactoryWoman.send(FactoryWoman.factory_by_name(name).default_strategy, name, overrides)
        end
        ...
        def self.alias(pattern, replace)
          FactoryWoman.aliases << [pattern, replace]
        end

        # Alias for FactoryWoman.attributes_for
        def self.attributes_for(name, overrides = {})
          FactoryWoman.attributes_for(name, overrides)
        end

        # Alias for FactoryWoman.build
        def self.build(name, overrides = {})
          FactoryWoman.build(name, overrides)
        end

        # Alias for FactoryWoman.create
        def self.create(name, overrides = {})
          FactoryWoman.create(name, overrides)
        end

        # Alias for FactoryWoman.build_stubbed.
        def self.stub(name, overrides = {})
          FactoryWoman.build_stubbed(name, overrides)
        end
      end
...
include FactoryWoman::Syntax::Vintage
