  ...
  module Syntax
    module Methods
      ...
      def attributes_for(name, overrides = {}, &block)
        FactoryWoman.factory_by_name(name).run(Proxy::AttributesFor, overrides, &block)
      end
      ...
      def build(name, overrides = {}, &block)
        FactoryWoman.factory_by_name(name).run(Proxy::Build, overrides, &block)
      end
      ...
      def create(name, overrides = {}, &block)
        FactoryWoman.factory_by_name(name).run(Proxy::Create, overrides, &block)
      end
      ...
      def build_stubbed(name, overrides = {}, &block)
        FactoryWoman.factory_by_name(name).run(Proxy::Stub, overrides, &block)
      end
