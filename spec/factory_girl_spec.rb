...
describe FactoryGirl do
  ...
  it "finds a registered factory" do
    ...
    FactoryGirl.factory_by_name(factory.name).should eq factory
  end

  it "finds a registered sequence" do
    FactoryGirl.register_sequence(sequence)
    FactoryGirl.sequence_by_name(sequence.name).should eq sequence
  end

  it "finds a registered trait" do
    FactoryGirl.register_trait(trait)
    FactoryGirl.trait_by_name(trait.name).should eq trait
  end
end
