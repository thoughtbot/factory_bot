...
describe "an instance generated by a factory that inherits from another factory" do
    ...
    FactoryGirl.define do
      factory :user do
        ...
        factory :admin do
          name "admin"
          admin true
          upper_email { email ? email.upcase : nil }
        end
  ...
  describe "non-overridden parent class dynamic methods assigned before the child's" do
    subject     { FactoryGirl.create(:admin) }
    its(:upper_email) { should == "ADMIN@EXAMPLE.COM"}
  end
  
  describe "parent class dynamic methods should be evaluated in the order they're defind" do
    subject     { FactoryGirl.create(:guest) }
