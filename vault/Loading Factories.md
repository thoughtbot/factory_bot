...
updated: 2025-08-29T17:23:30-05:00
tags: []
aliases: []
---
# Loading Factories
...
across the project. The load order is controlled by the `FactoryBot.definition_file_paths`
attribute.
...
- The `FactoryBot.find_definitions` method is called automatically by `factory_bot_rails` after initialize.
