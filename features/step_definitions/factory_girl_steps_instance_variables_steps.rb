...
Given /^I have set FactoryGirl::StepDefinitions.step_definitions_create_instance_variables to (false|true)$/ do |state|
  FactoryGirl::StepDefinitions.step_definitions_create_instance_variables = (state == "true") ? true : false
end
