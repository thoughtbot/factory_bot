Feature: Factory girl can find factory definitions correctly
  Scenario: Find definitions with a path
    ...
    """
    When "awesome_factories.rb" is added to Factory Woman's file definitions path
    And I create a "awesome_category" instance from Factory Woman
  ...
  Scenario: Find definitions with an absolute path
    ...
    """
    When "awesome_factories.rb" is added to Factory Woman's file definitions path as an absolute path
    And I create a "another_awesome_category" instance from Factory Woman
    Then I should find the following for the last category:
      | name       |
      | awesome!!! |
  ...
  Scenario: Find definitions with a folder
    ...
    """
    When "nested" is added to Factory Woman's file definitions path
    And I create a "great_category" instance from Factory Woman
    Then I should find the following for the last category:
      | name     |
      | great!!! |

  Scenario: Reload Factory Woman
    ...
    And I create a "handy_category" instance from Factory Woman
    Then I should find the following for the last category:
      | name     |
      | HANDY!!! |
