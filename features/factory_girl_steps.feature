Feature: Use step definitions generated by factories
  ...
  Scenario: create multiple non-ar factories and check output 
    Given the following train exists:
      | name       | base_station         |
      | red_flash  | chicago              |
      | blue_star  | new york             |
    Then I should find the following in the instance variable "@factories":
      | name       | base_station         |
      | blue_star  | new york             |
      | red_flash  | chicago              |

  Scenario: create single non-ar factory and check output 
    Given a post exists with a title of "a fun title"
    Then I should find the following in the instance variable "@factory":
      | title       |
      | a fun title |
